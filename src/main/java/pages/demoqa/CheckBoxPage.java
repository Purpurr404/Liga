...
public class CheckBoxPage extends BasePage {
    ...
    private static final String BUTTON_TOGGLE = CHECK_BOX_XPATH + "/../preceding-sibling::button[@title='Toggle']";
    ...
    public boolean isIsCheckBoxDisplay(String checkBoxName){
    ...
    public void openListCheckBox(String checkBoxName){
        if (isIsCheckBoxDisplay(checkBoxName)){
            click(By.xpath(String.format(BUTTON_TOGGLE, checkBoxName)));
        }
    }
    //button[@title='Toggle']
    //input[@type='checkbox'][following-sibling::span[text()='%s']]/../preceding-sibling::button[@title='Toggle']
}
